...
contract SoulmetaTokenTron is ERC20, Ownable {
    ...
    constructor () ERC20("Soul Meta Token", "SOUL") {
        _mint(_msgSender(), 1_000_000_000 trx);
        _holdBalances[_msgSender()] += 1_000_000_000 trx;
        _holdTotalSupply += 1_000_000_000 trx;
        require(totalSupply() == 1_000_000_000 trx);
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (totalSupply() > 100_000_000 trx) {
            if (from != address(0)) {
