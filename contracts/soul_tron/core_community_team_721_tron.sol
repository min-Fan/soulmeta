...
library AddressUpgradeable {
     ...
     *
     * Among others, `isTronContract` will return false for the following
     * types of addresses:
     *
     ...
     * [IMPORTANT]
     * ====
     * You shouldn't rely on `isTronContract` to protect against flash loan attacks!
     *
     ...
     * ====
     */
    function isTronContract(address account) internal view returns (bool) {
    ...
    function functionCallWithValue(
        ...
        require(isTronContract(target), "Address: call to non-contract");
    ...
    function functionStaticCall(
        ...
        require(isTronContract(target), "Address: static call to non-contract");
...
abstract contract Initializable {
    ...
    function _setInitializedVersion(uint8 version) private returns (bool) {
        ...
        if (_initializing) {
            require(
                version == 1 && !AddressUpgradeable.isTronContract(address(this)),
...
// File: contracts/soul/core_community_team_721.sol
...
contract SoulmetaTeamNFTTron is DivestorUpgradeable, ERC721EnumerableUpgradeable{
    using StringsUpgradeable for uint256;
    using SafeERC20Upgradeable for IERC20Upgradeable;
