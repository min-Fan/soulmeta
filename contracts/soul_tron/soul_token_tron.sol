...
// File: contracts/soul/soul_token.sol




contract SoulmetaTokenTron is ERC20, Ownable {
    using Address for address;
    uint ethers = 1e18;

    constructor () ERC20("Soul Meta Token", "SOUL") {
        _mint(_msgSender(), 1_000_000_000 * ethers);
        _holdBalances[_msgSender()] += 1_000_000_000 * ethers;
        _holdTotalSupply += 1_000_000_000 * ethers;
        require(totalSupply() == 1_000_000_000 * ethers);
    }
    ...
    function _beforeTokenTransfer(
        ...
        if (totalSupply() > 100_000_000 * ethers) {
            if (from != address(0)) {
