...
// File: contracts/interface/I_soul_bonus.sol
...
// File: contracts/interface/I_soul_store.sol
...
// File: contracts/interface/I_soul_token.sol
...
// File: contracts/interface/I_soul_team.sol
...
// File: contracts/interface/I_soul_721.sol
...
// File: contracts/interface/I_soul_1155.sol
...
// File: contracts/other/random_generator_upgradeable.sol
...
// File: contracts/other/divestor_upgradeable.sol
...
// File: contracts/soul_cube/core_controller_cube.sol
...
contract SoulmetaControllerTron is DivestorUpgradeable, RandomGeneratorUpgradeable {
    ...
    function buildBox(uint8 theme_, uint8 group_, uint soulCount_, uint amount_, address recommender_) public {
        ...
        //        uint b2 = cUsdt.balanceOf(aSoulPair) * 1 trx / U_ACC;
        //        if (b1 != 0 && b2 != 0) {
        //            uint uintPrice = (b2 * 1 gwei / b1);
        //            //单价
        //            if (soulCount_ == 0) {
        //                burn = 6 gwei * 1 trx / uintPrice;
        //            } else if (soulCount_ == 5) {
        //                burn = 20 gwei * 1 trx / uintPrice;
        //            } else if (soulCount_ == 10) {
        //                burn = 50 gwei * 1 trx / uintPrice;
        //            } else if (soulCount_ == 15) {
        //                burn = 60 gwei * 1 trx / uintPrice;
        //            } else if (soulCount_ == 20) {
        //                burn = 100 gwei * 1 trx / uintPrice;
        //            }
        //        } else {
        //            burn = 1 trx;
        //        }
