...
describe('Testing cureRouter', function () {
    ...
    beforeEach(async () => {
        ...
        let Controller = await ethers.getContractFactory('SoulmetaControllerCube')
        controller = await Controller.deploy()

        let Usdt = await ethers.getContractFactory('EvilUSDT')
        usdt = await Usdt.deploy()

        let Router = await ethers.getContractFactory("SoulMetaRouterCube")
        router = await Router.deploy()

        let Receive = await ethers.getContractFactory('SoulmetaTokenReceiveCube')
